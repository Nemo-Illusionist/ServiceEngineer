...
namespace ServInger.UILogic.ViewModels {
    class TechnicalCardPageViewModel : ViewModelBase {
        ...
        private List<TechnicalCardEntity> _technCards;
        public List<TechnicalCardEntity> TechnicalCards {
            get { return _technCards; }
            set { SetProperty(ref _technCards, value); }
        }
        ...
        public TechnicalCardPageViewModel(IDBTaskManager dbTaskManager, INavigationService navigationService,
                  ITaskService taskService, ICamera camera, IFlashlight flashlight) {
        ...
        public override async void OnNavigatedTo(NavigatedToEventArgs e, Dictionary<string, object> viewModelState) {
            ...
            string ErrMess = "";
            try {
                TechnicalCards = _dbTaskManager.getTechCard(_taskService.get());
            } catch (Exception ex) {
                flag = true;
                ErrMess = ex.Message;
            }
        ...
        public override async void OnNavigatingFrom(NavigatingFromEventArgs e, Dictionary<string, object> viewModelState, bool suspending) {
            ...
            string ErrMess = "";
            try {
                _dbTaskManager.updateTechCard(TechnicalCards);
            } catch (Exception ex) {
                flag = true;
                ErrMess = ex.Message;
            }
